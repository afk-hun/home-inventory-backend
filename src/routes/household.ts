...
import { createHousehold, deleteHousehold, getHouseholds, renameHousehold, setHousehold } from "../controller/household";
...
router.post("/set-household", isAuth, validateCsrf, setHousehold);
